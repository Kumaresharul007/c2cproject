...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $error = false;
        if(strlen($pass1) < 8){
           $err = "Your password should be minimum 8 characters!";
           $error = true;
        }
        if(ctype_upper("$pass1") || ctype_lower("$pass1")){
           $err = "Your password should have a different characters!";
           $error = true;
        }
        if($pass1 != $pass2){
        ...
        if($error == false){
            $hashed = md5($pass2);
            $sql = "INSERT INTO registration (user, email, pass2) VALUES ('$name', '$mail', '$hashed')";
            if(mysqli_query($conn, $sql)){
            $_SESSION['done'] = "Your account has been created successfully!";
            header("Location: homepage2.php");
            }
            else{
            $err = "This username have already been taken!";
            }
        }
    }
?>
<?php
    if(isset($_POST['submit2'])){
        ...
        $pass3 = $_POST['password2'];
        $pass3 = md5($pass3);
        $sql = "SELECT * FROM registration WHERE user = '$user2' AND pass2 = '$pass3'";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <li><a class="dropdown-item" href="corporateloan.php">Builders/ Developers</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle active" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="d-flex">
                <button type="button" style="margin-right: 10px;" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#loginModal">
                    Login
                </button>
            ...
            <div class="modal-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <ul>
                      <li style="font-size: 15px;">Password must be minimum of 8 characters.</li>
                      <li style="font-size: 15px;">Your password must have different characters.</li>
                    </ul>
                    <div class="form-group">
...
<div><h1 class="text-center" style="font-weight: 500; color: black;">About Us</h1></div>
<br>
...
<div><h1 class="text-center" style="font-weight: 500; color: black;">Loan Enquiry</h1></div>
<br>
<section>
 <div class="container">
  <div class="row">
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <p class="text mb-3">Email 1:<a href="#">200801119@rajalakshmi.edu.in</a>
          <p class="text mb-3">Email 2:<a href="#">200801118@rajalakshmi.edu.in</a>
          <p class="text mb-3">Phone No 1:<a href="#">+91 96554 13375</a>
          <p class="text mb-3">Phone No 2:<a href="#">+91 89035 07021</a>
        </div>
      </div>
    </div>
    <div class="col-sm-6">
